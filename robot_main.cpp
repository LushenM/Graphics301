...
void base(void) {
    ...
    specular[0] = 0.1;  // You can keep specular properties the same
    specular[1] = 0.1;
    specular[2] = 0.1;
...
void keyboard(unsigned char key, int x, int y) {
    ...
    case 'z':
        theta[1] -= 5.0;
        if (theta[1] < -90.0) // Use < for less than
            theta[1] = -90.0;
        break;
    ...
    case 'p':
        theta[2] -= 5.0;
        if (theta[2] < -45.0) // Use < for less than
            theta[2] = -45.0;
        break;
    ...
    case 'r':
        theta[0] = theta[1] = theta[2] = theta[3] = theta[4] = theta[5] = theta[6] = 0.0;
        break;
